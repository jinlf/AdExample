...
//
//  Copyright 2011 Cartoon Inc. All rights reserved.
//
...
/// request is in progress or if the latest ad request failed. For both standard and mediated Cartoon
/// AdMob ads, this method returns @"GADMAdapterCartoonAdMobAds". For ads fetched via mediation
